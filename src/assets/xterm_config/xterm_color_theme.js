...
window.inflateOptions([
	...
	},
	{
		...
		description: "The accent color of the cursor, used as the foreground color for block cursors.",
		path: ["theme", "cursorAccent"],
	},
...
selectionColorOption.set = function(value) {
	...
	selectionColorOpacityOption.el.querySelector("input").value = Math.round(parseInt(value.substring(7), 16) / 255 * 100) / 100;
};
